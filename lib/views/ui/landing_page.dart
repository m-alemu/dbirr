...
import 'package:dbirr/controller/ui/landing_controller.dart';
import 'package:dbirr/helpers/theme/app_style.dart';
import 'package:dbirr/helpers/utils/ui_mixins.dart';
import 'package:dbirr/widgets/my_button.dart';
import 'package:dbirr/widgets/my_container.dart';
import 'package:dbirr/widgets/my_flex.dart';
import 'package:dbirr/widgets/my_flex_item.dart';
import 'package:dbirr/widgets/my_list_extension.dart';
import 'package:dbirr/widgets/my_responsiv.dart';
import 'package:dbirr/widgets/my_spacing.dart';
import 'package:dbirr/widgets/my_text.dart';
import 'package:dbirr/widgets/my_text_style.dart';
import 'package:dbirr/widgets/responsive.dart';
import 'package:dbirr/images.dart';
                                ...
                                return Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      MySpacing.height(40),
                                      MyText.titleLarge(
                                        "dbirr - Responsive Web UI Kit & Dashboard Template",
                                        fontSize: 28,
                                      ),
                                      MySpacing.height(40),
                                      MyText.titleMedium(
                                        "dbirr is a fully featured dashboard and admin template comes with tones of well designed UI elements, components, widgets and pages.",
                                      ),
                                      MySpacing.height(40),
                                      Row(
                                        children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        MySpacing.height(flexSpacing),
                        MyText.bodyMedium(
                            "dbirr comes with next generation ui design and have multiple benefits"),
                              ...
                              MyFlexItem(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      MySpacing.height(28),
                                      buildFAQItem(
                                          "Will you regularly give updates of dbirr?",
                                          controller.dummyTexts[1]),
                                    ],
                                  )),
                            ],
